...
public class PlayerChangeServerEvent extends Event implements Cancellable {
	...
	private String messageStr = ChatColor.GRAY + "Przelaczanie na serwer " + ChatColor.GOLD + null + ChatColor.GRAY + "...";
	
	public PlayerChangeServerEvent(Player player, String server, String serverAddress) {
		playerPla = player;
		serverStr = server;
		serverAddressStr = serverAddress;
		messageStr = ChatColor.GRAY + "Przelaczanie na serwer " + ChatColor.GOLD + server + ChatColor.GRAY + "...";
	}
